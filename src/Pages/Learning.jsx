        ...
        <div className="flex justify-center items-center">
          <div className="max-w-md m-4 bg-gray-200 p-4 rounded-lg flex hover:cursor-pointer">
            <div className="flex flex-col justify-center max-w-xs">
              <div className="mb-4">
                <p className="text-xs uppercase font-bold text-gray-600 bg-yellow-300 px-1 rounded-full ml-20 w-[50%] py-2">MOST POPULAR</p>
              </div>
            ...
            <div className="ml-4">
              <img src="/src/assets/Images/build.jpg" alt="" className="w-48 h-48 rounded-lg" />
            </div>
          </div>
          <div className="max-w-md m-4 bg-gray-200 p-4 rounded-lg flex hover:cursor-pointer">
            ...
            <div className="ml-4">
              <img src="/src/assets/Images/math.jpg" alt="" className="w-48 h-48 rounded-lg" />
            </div>
          </div>
        </div>
      </div>
